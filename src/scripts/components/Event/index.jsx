        ...
        return (
            <div>
                ...
                <div style={pageStyle.leftSide}>
                    <li style={pageStyle.link} value={eventA}
                        onClick={() => this.changeImage(eventA)}>{eventA.title}</li>
                    <li style={pageStyle.link} value={eventB}
                        onClick={() => this.changeImage(eventB)}>{eventB.title}</li>
                </div>
