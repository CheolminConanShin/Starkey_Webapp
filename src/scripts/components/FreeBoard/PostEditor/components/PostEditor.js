        ...
        return (
            <div className="panel panel-default" style={styles.postEditor}>
                <div className="panel-body">
                    ...
                    <input style={Object.assign({}, styles.inputForm)} className='well-sm' placeholder='고객성함'
                           value={this.state.name} onChange={this.handlePostEditorNameChange}/>
                    <input style={Object.assign({}, styles.inputForm, styles.passwordForm)} className='well-sm'
                           placeholder='비밀번호' value={this.state.password}
                           onChange={this.handlePostEditorPasswordChange}/>
                    <button className="btn btn-primary" style={styles.postEditorButton} onClick={this.createPost}>질문하기
                    </button>
                </div>
            </div>
        )
